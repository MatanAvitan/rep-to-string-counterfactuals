...
bios_train_df.to_csv(
    f'/home/nlp/matan_avitan/git/vec2text_inter/bios_data/{BASE_MODEL}_{MAX_SEQUENCE_LENGTH}_{NUM_CORRECTION_STEPS}_{BEAM_SEARCH_SIZE}.csv',
