...
EXP_NAME = 'new_ot_hard_text_and_counterfactuals'
MAX_LENGTH = 64
SEED = 0
IS_FIRST = True
...
ot_females_to_males_path = f'bios_extracted_data/new_ot_females_to_males.csv'
ot_males_to_females_path = f'bios_extracted_data/new_ot_males_to_females.csv'
