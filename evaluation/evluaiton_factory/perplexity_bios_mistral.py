...
ot_females_to_males = f'{base}/mimic_female_to_male.csv'
ot_females_to_males_df = pd.read_csv(ot_females_to_males)
new_ot_males_to_females = f'{base}/mimic_plus_male_to_female.csv'
new_ot_males_to_females_df = pd.read_csv(new_ot_males_to_females)
new_ot_females_to_males = f'{base}/mimic_plus_female_to_male.csv'
