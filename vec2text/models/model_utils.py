...
device = get_device()
# device = 'cuda:4'  # least females -> males
# device = 'cuda:5'  # least males -> females
# device = 'cuda:6'  # leace removal
# device = 'cuda:6'  # leace removal males
# device = 'cuda:3'  # New OT females->males
# device = 'cuda:0'  # New OT males->females
...
def load_tokenizer(name: str, max_length: int) -> transformers.PreTrainedTokenizer:
    ...
    if tokenizer.pad_token is None:
        tokenizer.pad_token = tokenizer.eos_token
    tokenizer.decoder_start_token_id = tokenizer.pad_token_id
