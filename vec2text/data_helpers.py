...
def load_bias_bios_corpus() -> datasets.Dataset:
    return datasets.load_from_disk('/home/nlp/matan_avitan/git/vec2text/train_data/bias_bios')
...
def dataset_from_args(data_args: DataArguments) -> datasets.DatasetDict:
    ...
    elif data_args.dataset_name == "bias-bios":
        raw_datasets = load_bias_bios_corpus()
